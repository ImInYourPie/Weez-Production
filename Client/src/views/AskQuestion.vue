                    ...
                    <div class="columns is-multiline">
                      <div class="column is-12">
                        <div class="has-text-centered" v-if="!questions">
                          <h1 class="subtitle is-size-6">As perguntas aparecem aqui à medida que insere o titulo</h1>
                        </div>
                        <div
...
export default {
  ...
  watch: {
    title: _.debounce(async function(value) {
      console.log(value)
      this.loading = true;
      if(value) this.questions = (await QuestionsService.returnQuestionByTitle(value)).data;
